...
//        //  test lowestAverage method
        ...
        int[] lowestAverageArray = lowestAverage(weeklyMonthTemperatures);

        for (int element : lowestAverageArray) {
...
//        // within your main method...
    ...
    public static int[] lowestAverage(int[][] arrayOfArrays) {
        float[] lowestAverage = new float[arrayOfArrays[0].length];
...
//            System.out.println(arraysAverages[i]);
        ...
        return arrayOfArrays[indexNwmber];
    }
